...
namespace DAO
{
    ...
    public partial class KindOfBanking
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public KindOfBanking()
        {
            this.additionalInformationByContact = new HashSet<additionalInformationByContact>();
        }
    
        public int kob_id { get; set; }
        public string kob_description { get; set; }
        public Nullable<bool> kob_state { get; set; }
